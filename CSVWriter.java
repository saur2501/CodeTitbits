...
public class CSVWriter {
    ...
    public static void saveInCSV(Map<String, LinkedHashMap<String, String>> allmetricsmap, String nameOfFile) throws Exception {
        System.out.println("Context- CSVReporter/saveInCSVMetricsMap; name of file- " + nameOfFile + "; $prop; \nQueryMetricMap : \nKeyset: " + allmetricsmap.keySet() + "\nValues" + allmetricsmap.values());
        // Setting up header-names for the CSV
        String[] header = null;
        int i = 0;
        System.out.println("Size of metricsMap = " + allmetricsmap.size());
        for (Entry<String, LinkedHashMap<String, String>> metricsInstance : allmetricsmap.entrySet()) {				//Single iteration of first elt
        ...
        try {
            mapWriter = new CsvMapWriter(new FileWriter("C:\\Users\\Saurabh\\Desktop\\abc.csv"),
    ...
    public static void main(String[] args) throws Exception {
        ...
        saveInCSV(map, "Hi");
        LinkedHashMap<String, String> mapper3 = new LinkedHashMap<>();
        mapper3.put("key2", "value5");
        mapper3.put("key4", "value6");
        map.put("HyperKey3", mapper3);
        saveInCSV(map, "Hi");
